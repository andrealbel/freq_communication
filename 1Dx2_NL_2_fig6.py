...
# Nonlinear excitatory-inhibitory networks of two 1D cells
# Fig 6
...
if ej ==1 :
    axs[0].axis([0,fmax,-2.6,1.6])
if ej == 2:
    axs[0].axis([0,fmax,-2.6,2.6])
if ej == 3:
    axs[0].axis([0,fmax,-1.9,10.5])
...
if ej == 1:
   savefig('NL21_1_kmax.pdf')
if ej == 2:
   savefig('NL22_1_kmax.pdf')
if ej == 3:
   savefig('NL23_1_kmax.pdf')
...
if ej ==1:
   pyplot.text(-3,.4, r'$f=1$', fontsize =font1)
   pyplot.text(-3.35,1., r'$f=20$', fontsize =font1)
   pyplot.text(-2,0.6, r'$f=100$', fontsize =font1)
   pyplot.text(-1.8,1.3
   , r'$K$-curve', fontsize =font1)
   pyplot.text(-1.9,1.95, r'$A_{in}=0.1$', fontsize =font1)
   pyplot.arrow(-2.37,.9,.35,-.25,width=0.001,head_width=0.02,fc='k', ec='k',zorder=2)
if ej ==2:
   pyplot.text(-3.4,.2, r'$f=1$', fontsize =font1)
   pyplot.text(-3.95,1.2, r'$f=20$', fontsize =font1)
   pyplot.text(-1.7,0.5, r'$f=100$', fontsize =font1)
   pyplot.text(-1.3,2.2, r'$K$-curve', fontsize =font1)
   pyplot.text(-1.5,2.75, r'$A_{in}=0.2$', fontsize =font1)
   pyplot.arrow(-2.27,.88,.45,-.25,width=0.001,head_width=0.02,fc='k', ec='k',zorder=2)
if ej ==3:
   pyplot.text(-5,2.9, r'$f=1$', fontsize =font1)
   pyplot.text(-7.2,5.7, r'$f=20$', fontsize =font1)
   pyplot.text(-13,2.5, r'$f=100$', fontsize =font1)
   pyplot.text(1.7,1.5, r'$K$-curve', fontsize =font1)
   pyplot.text(1,10.5, r'$A_{in}=1$', fontsize =font1)
   pyplot.arrow(-4.2,1.15,-6,1,width=0.005,head_width=0.1,fc='k', ec='k',zorder=2)
   pyplot.arrow(.4,3.2,1,-1,width=0.005,head_width=0.1,fc='k', ec='k',zorder=2)
pyplot.xlabel(r'$v_1$', fontsize =font1)
pyplot.ylabel(r'$v_2$', fontsize =font1)
pyplot.legend(loc=2,fontsize=font2)
pyplot.xticks(fontsize=font1)
pyplot.yticks(fontsize=font1)
if ej == 1:
    pyplot.axis([-3.4,-1.25,0.3,2.1])
    pyplot.xticks([-3,-2.5,-2,-1.5],fontsize=font1)
    pyplot.yticks([.4,.8,1.2,1.6,2.],fontsize=font1)
if ej == 2:
    pyplot.axis([-4.25,-0.3,0.1,3])
    pyplot.xticks([-4,-3,-2,-1],fontsize=font1)
if ej == 3:
    pyplot.axis([-13,6,-.2,11.5])
    pyplot.xticks([-12,-8,-4,0,4],fontsize=font1)
pyplot.tight_layout()

if ej == 1:
   savefig('NL21_3_kmax.pdf')
if ej == 2:
   savefig('NL22_3_kmax.pdf')
if ej == 3:
   savefig('NL23_3_kmax.pdf')
...
if ej ==1:
   ax1.text(-2,1, r'$K$-curve', fontsize =font1)
   ax1.axis([-2.8,-1.6,.65,2.1])
if ej ==2:
   ax1.text(-1.7,1., r'$K$-curve', fontsize =font1)
   ax1.axis([-2.6,-1.1,0.75,3.2])
if ej ==3:
   ax1.text(2.5,5, r'$K$-curve', fontsize =font1)
   ax1.axis([-3,6,0,15])
...
if ej ==1:
   ax2.text(120,1, r'$ang(\vec{P},\vec{T})$', fontsize =20)
if ej > 1:
   ax2.text(120,1.9, r'$ang(\vec{P},\vec{T})$', fontsize =20)
ax2.axis([0,fmax,0.7,3.2])
if ej > 1:
...
if ej == 1:
   savefig('NL21_4_kmax.pdf')
if ej == 2:
   savefig('NL22_4_kmax.pdf')
if ej == 3:
   savefig('NL23_4_kmax.pdf')
